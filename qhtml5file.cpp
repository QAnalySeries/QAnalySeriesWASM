...
/*
void QHtml5File2::load(const QString &accept, std::function<void(const QByteArray &, const QString &)> fileDataReady)
{
...
void QHtml5File2::save(const QByteArray &contents, const QString &fileNameHint)
{
